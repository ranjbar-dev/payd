...
var apiRoutes = []route{
	...
	{http.MethodPost, "/api/v1/orders/{id}/extend", "orders:write", func(s *Server) http.HandlerFunc { return s.extendOrder }},
	{http.MethodGet, "/api/v1/orders/{id}/events", "orders:read", func(s *Server) http.HandlerFunc { return s.orderEvents }},
	...
	{http.MethodGet, "/api/v1/payments", "orders:read", func(s *Server) http.HandlerFunc { return s.listAllPayments }},
	...
	{http.MethodPost, "/api/v1/ipn/test", "orders:write", func(s *Server) http.HandlerFunc { return s.testIPN }},
	{http.MethodPost, "/api/v1/ipn/replay", "orders:write", func(s *Server) http.HandlerFunc { return s.replayIPN }},
	{http.MethodGet, "/api/v1/chain/params", "wallets:read", func(s *Server) http.HandlerFunc { return s.chainParameters }},
	{http.MethodGet, "/api/v1/chain/status", "wallets:read", func(s *Server) http.HandlerFunc { return s.chainStatus }},
	{http.MethodGet, "/api/v1/chain/quota", "wallets:read", func(s *Server) http.HandlerFunc { return s.chainQuota }},
	...
	{http.MethodGet, "/api/v1/auth/whoami", "", func(s *Server) http.HandlerFunc { return s.whoami }},
	{http.MethodGet, "/api/v1/assets", "", func(s *Server) http.HandlerFunc { return s.listAssets }},
	{http.MethodGet, "/api/v1/workers", "wallets:read", func(s *Server) http.HandlerFunc { return s.workers }},
	{http.MethodGet, "/api/v1/audit", "admin:read", func(s *Server) http.HandlerFunc { return s.auditLog }},
	{http.MethodGet, "/api/v1/resources/grants", "wallets:read", func(s *Server) http.HandlerFunc { return s.listResourceGrants }},
	{http.MethodGet, "/api/v1/resources/wallet", "wallets:read", func(s *Server) http.HandlerFunc { return s.resourceWallet }},
	{http.MethodGet, "/api/v1/config", "admin:read", func(s *Server) http.HandlerFunc { return s.effectiveConfig }},
	{http.MethodGet, "/api/v1/reports/volume", "orders:read", func(s *Server) http.HandlerFunc { return s.volumeReport }},
	{http.MethodGet, "/api/v1/reports/fees", "wallets:read", func(s *Server) http.HandlerFunc { return s.feeReport }},
	{http.MethodGet, "/api/v1/export/orders.csv", "orders:read", func(s *Server) http.HandlerFunc { return s.exportOrdersCSV }},
	...
	{http.MethodPost, "/api/v1/withdrawals/estimate", "withdrawals:read", func(s *Server) http.HandlerFunc { return s.estimateWithdrawal }},
	{http.MethodGet, "/api/v1/withdrawals/{id}", "withdrawals:read", func(s *Server) http.HandlerFunc { return s.getWithdrawal }},
	{http.MethodPost, "/api/v1/withdrawals/{id}/resolve", "withdrawals:write", func(s *Server) http.HandlerFunc { return s.resolveWithdrawal }},
}
